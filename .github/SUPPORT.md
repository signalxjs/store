...
[GitHub Discussions](https://github.com/signalxjs/store/discussions). It keeps
...
- [Report a bug](https://github.com/signalxjs/store/issues/new?template=bug_report.yml)
- [Request a feature](https://github.com/signalxjs/store/issues/new?template=feature_request.yml)

Before filing, please:

- Check existing [issues](https://github.com/signalxjs/store/issues?q=is%3Aissue) and
  [discussions](https://github.com/signalxjs/store/discussions) to avoid duplicates.
